package com.xuanqi.he.o2omvp.modlues.personal.activity.settingpaymentpassword;
...
public class SettingPaymentPasswordActivity extends MVPBaseActivity<SettingPaymentPasswordContract.View, SettingPaymentPasswordPresenter> implements SettingPaymentPasswordContract.View, View.OnTouchListener {
    ...
    TextView mConfirm;
    @BindView(R.id.activity_setting_payment_password)
    LinearLayout mRoot;
