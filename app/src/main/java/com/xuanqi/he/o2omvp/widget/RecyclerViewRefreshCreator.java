...
public class RecyclerViewRefreshCreator extends RefreshViewCreator {
    ...
    public View getRefreshView(Context context, ViewGroup parent) {
        View refreshView = LayoutInflater.from(context).inflate(R.layout.refresh_header, parent, false);
