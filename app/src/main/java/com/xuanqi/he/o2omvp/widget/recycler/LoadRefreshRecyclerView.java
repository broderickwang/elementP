...
public class LoadRefreshRecyclerView extends RefreshRecyclerView {
    ...
    //最后一页没有数据
    public int LOAD_STATUS_NO_DATA = 0x0055;
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (canScrollDown() || mCurrentLoadStatus == LOAD_STATUS_LOADING
                        || mCurrentLoadStatus == LOAD_STATUS_NO_DATA
     ...
     * 停止加载更多
     */
    public void onStopLoad(int currentCount, int count) {
...
//        }
    ...
    public boolean isLoading() {
        return mCurrentLoadStatus == LOAD_STATUS_LOADING;
    }
    ...
    private OnFingerDragDistanceListener mDistanceListener;

    public interface OnFingerDragDistanceListener {
        void onFingerUp(int distance);
    }

    public void setOnFingerDragDistanceListener(OnFingerDragDistanceListener distanceListener) {
