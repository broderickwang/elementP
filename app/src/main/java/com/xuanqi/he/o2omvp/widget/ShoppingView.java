...
public class ShoppingView extends View {
    ...
    private final static String DEFAULT_SHOPPING_TEXT = "加入";
...
//        LogUtils.e("TAG","init");
        ...
        //背景色
        int bgColor = typeArray.getColor(R.styleable.ShoppingView_sv_bg_color, ContextCompat.getColor(getContext(), R.color.red));
        typeArray.recycle();
...
//        MAX_WIDTH = getTextWidth(mPaintText, mShoppingText) / 5 * 8;
        MAX_WIDTH = getTextWidth(mPaintText, mShoppingText);
//        MAX_HEIGHT = textSize * 2;
        MAX_HEIGHT = textSize * 9 / 5;
