...
public class RadiusBackgroundSpan extends ReplacementSpan {
     ...
     * @param radius 圆角半径
     */
    public RadiusBackgroundSpan(int color, int radius,int padding) {
        mColor = color;
        mRadius = radius;
        mPadding = padding;
    }
...
//        int color = paint.getColor();//保存文字颜色
        ...
        RectF oval = new RectF(x, y + paint.ascent() - mPadding, x + mSize, y + paint.descent() + mPadding);
