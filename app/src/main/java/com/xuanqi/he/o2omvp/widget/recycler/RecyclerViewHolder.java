...
public class RecyclerViewHolder extends RecyclerView.ViewHolder {
     ...
     * 设置View的Visibility
     */
    public RecyclerViewHolder setViewVisibility(@IdRes int viewId, int visibility) {
     ...
     * 设置ImageView的资源
     */
    public RecyclerViewHolder setImageResource(@IdRes int viewId, int resourceId) {
     ...
     * 也可以直接写死
     */
    public RecyclerViewHolder setImageByUrl(@IdRes int viewId, HolderImageLoader imageLoader) {
        ImageView imageView = getView(viewId);
        if (imageLoader == null) {
