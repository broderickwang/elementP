...
public class WrapRecyclerView extends RecyclerView {
    ...
    public void addHeaderView(View view) {
        ...
        if (mWrapRecyclerAdapter == null) {
            throw new NullPointerException("adapter is null, execute method 'addHeaderView(View view)' after 'setAdapter(RecyclerView.Adapter adapter)'");
        }
        /*if (mWrapRecyclerAdapter != null) {
    ...
    public void addFooterView(View view) {
        if (mWrapRecyclerAdapter == null) {
            throw new NullPointerException("adapter is null, execute method 'addFooterView(View view)' after 'setAdapter(RecyclerView.Adapter adapter)'");
        }
        /*if (mWrapRecyclerAdapter != null) {
    ...
    public void removeHeaderView(View view) {
        if (mWrapRecyclerAdapter == null) {
            throw new NullPointerException("adapter is null, execute method 'removeHeaderView(View view)' after 'setAdapter(RecyclerView.Adapter adapter)'");
        }
        /*if (mWrapRecyclerAdapter != null) {
    ...
    public void removeFooterView(View view) {
        if (mWrapRecyclerAdapter == null) {
            throw new NullPointerException("adapter is null, execute method 'removeFooterView(View view)' after 'setAdapter(RecyclerView.Adapter adapter)'");
        }
        /*if (mWrapRecyclerAdapter != null) {
    ...
    public int getHeaderViewCount(){
        ...
        return mWrapRecyclerAdapter.getHeaderViewCount();
    }
    ...
    public int getFooterViewCount(){
        ...
        return mWrapRecyclerAdapter.getFooterViewCount();
    }
